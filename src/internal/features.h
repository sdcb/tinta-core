...
#ifndef TINTA_ENABLE_SVG
#define TINTA_ENABLE_SVG 1
#endif

#ifndef TINTA_ENABLE_MATH
#define TINTA_ENABLE_MATH 1
#endif

#define TINTA_ENABLE_RASTER_IMAGES \
    (TINTA_ENABLE_REMOTE_IMAGES || TINTA_ENABLE_LOCAL_IMAGES)

#define TINTA_ENABLE_IMAGES \
    (TINTA_ENABLE_RASTER_IMAGES || TINTA_ENABLE_SVG)
